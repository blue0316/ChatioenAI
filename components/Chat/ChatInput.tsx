...
export const ChatInput = ({
  ...
  return (
    <div className="bottom-0 left-0 w-full border-transparent bg-gradient-to-b from-transparent via-white to-white pt-6 md:pt-2 shrink-0  px-3 py-3 mt-auto">
      <div className="rounded-lg border-zinc-300 mx-2 mt-4 flex flex-col gap-3 last:mb-2 md:mx-4 md:mt-[35px] md:last:mb-6 lg:mx-auto lg:max-w-3xl items-center">
        {messageIsStreaming && (
          <button
            style={{ top: '-10px' }}
            className="left-0 right-0 mx-auto mb-3 flex w-fit items-center gap-3 rounded border border-neutral-200 bg-white py-2 px-4 text-black hover:opacity-50 md:mb-0 md:mt-2"
        ...
        <div className="relative mx-2 flex w-full flex-grow flex-col rounded-xl border border-black/10 bg-white shadow-[0_0_10px_rgba(0,0,0,0.10)] sm:mx-4">
          ...
          <textarea
            ...
            placeholder={t('Type message or type / to select a prompt') || ''}
            value={content}
            rows={1}
